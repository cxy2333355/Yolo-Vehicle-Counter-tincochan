...
cap = cv.VideoCapture("D:/trafficSample/Yolo-Vehicle-Counter-tincochan/12.mp4")
...
out = cv.VideoWriter("D:/trafficSample/Yolo-Vehicle-Counter-tincochan/out12.avi", fourcc, fps, (1920, 1080), True)
